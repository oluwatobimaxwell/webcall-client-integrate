...
class WebCallClient {
	...
	init({ clientId }) {
		...
		this.getLocation((latLng = {}) => {
			...
			this.wrapMain.style = `transition: all ${this.transitionTime}s ease-in-out 0s; cursor: pointer; position: fixed;  width: ${window.innerWidth > 800 ? this.dimensions.defaultWidth : "100%"}; overflow: hidden; top: ${this.dimensions.top()}; right:  100px; height: ${this.dimensions.height}; z-index: 1000000000000000000000000000000 `;
